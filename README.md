...
-----------------------
This system is designed to run on Linux and UNIX distributions. There is no current support for Windows operating systems.
Download and install the current release package from the releases section of the repository. Use your package installer or command line to install the package python-superhoneypot and any dependencies you may be missing.
